    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("출발 날짜 : ${_rangeStart != null ? DateFormat("yyyy년 MM월 dd일").format(_rangeStart!) : '날짜를 선택해주세요.'}"),
          Text("도착 날짜 : ${_rangeEnd != null ? DateFormat("yyyy년 MM월 dd일").format(_rangeEnd!) : '날짜를 선택해주세요.'}"),
          Container(
